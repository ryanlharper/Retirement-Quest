# advsior probabilties (stocks (lc), bonds(gb), commodities(comm))
import random

def mgr_performance_calc(funds):
    lc_probability_list = []
    ...
    if comm ==1:
        ...
        comm = random.randint(35,49)
    elif comm ==7:
        comm = random.randint(47,50)
    elif comm == 8:
        comm = random.randint(50,55)

    #performance calcualtion
    cf_perf = random.randint(0,2)/100*(funds[3]["Money Market Fund"]/100)
